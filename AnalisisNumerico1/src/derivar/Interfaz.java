...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String funcion, var5, variable;
        double var4, valor;
        
        funcion = jTextField2.getText();
        variable = jTextField3.getText();
        
        valor = Double.parseDouble(jTextField4.getText());
        
        var4 = eval(funcion, variable, valor);
        
        var5 = String.valueOf(var4);
        
        jTextField2.setText(var5);
    }//GEN-LAST:event_jButton2ActionPerformed

    public double eval(String funcion, String variable, double valor){
        double resul;
        //String expresion = var3;
